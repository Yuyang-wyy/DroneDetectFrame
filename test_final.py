...
class UltraLightSegmentation(nn.Module):
    def __init__(self, num_classes):
        ...
        self.aspp = ASPP(in_channels=576, out_channels=128)  # MobileNetV3-Small 输出通道数为 576，out_channels要和aspp_out_channels=64一致
...
if __name__ == '__main__':
    ...
    def train_model(model, train_loader, val_loader, criterion, optimizer, num_epochs):
        checkpoint_dir = 'E:/Robotics/Work/cv/codes/deepmodel_final'
